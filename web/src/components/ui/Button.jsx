...
export default function Button({
  ...
  const baseClasses = "inline-flex items-center justify-center rounded px-3 py-1.5 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-blue-600 min-h-[32px] whitespace-nowrap transition-all";
